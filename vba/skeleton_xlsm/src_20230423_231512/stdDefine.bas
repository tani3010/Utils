...
Public Const ST_DBCONFIG As String = "DB_CONFIG"
...
' ===== format string =====
Public Const FMT_DATE_YYYYMMDD_ISO       As String = "yyyy-mm-dd"
Public Const FMT_DATE_YYYYMMDDHHMMSS_ISO As String = "yyyy-mm-ddThh:mm:ss"
...
Public Const FMT_DATE_MMDDYYYYHHMMSS_SEP As String = "mm/dd/yyyy hh:mm:ss"
Public Const FMT_DATE_MMDDYYYY_SEP       As String = "mm/dd/yyyy"
